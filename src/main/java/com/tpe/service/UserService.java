...
public class UserService {
    ...
    @Autowired
    private RoleService roleService;// roll le ilgili birsey yapacaksam onu roll service de yapmaliyim

    @Autowired
    private PasswordEncoder passwordEncoder;// pasword' encodder etmek icin
